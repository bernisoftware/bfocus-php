 ...
 * registra cada requisição recebida CRUA em `$BFOCUS_MOCK_DIR/requests.jsonl` e responde com a
...
if (!$response instanceof stdClass) {
    ...
    echo json_encode(['code' => 418, 'data' => null, 'message' => 'MOCK_UNEXPECTED_REQUEST', 'error' => 'MOCK_UNEXPECTED_REQUEST']);
...
if (is_string($response->body)) {
    ...
    header('Content-Type: application/json');
    echo json_encode($response->body, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE | JSON_PRESERVE_ZERO_FRACTION);
}
